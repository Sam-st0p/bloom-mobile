              ...
              background: Container(
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color(0xFF2D4A18), Color(0xFF3A5A20)],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Seminars, calendar & your certificates',
                        style: GoogleFonts.nunito(
...
class _SeminarsTabState extends State<_SeminarsTab> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_seminars.isEmpty) return const _EmptyState(
        icon: '🎓',
                ...
                ? Stack(fit: StackFit.expand, children: [
                    Image.network(sem['cover_image_url'],
                        ...
                        errorBuilder: (_, __, ___) =>
                            Container(color: const Color(0xFF2D4A18))),
                                    ...
                                    children: [
                                      Text('Seminar Evaluation Form',
                                          style: GoogleFonts.nunito(
                                              ...
                                              color: Colors.white)),
                                      Text(
                                          'Please rate each criterion from 1 (Poor) to 5 (Excellent)',
                                          style: GoogleFonts.nunito(
                                              fontSize: 11,
                    ...
                    children: [
                      Text('$day',
                          style: GoogleFonts.nunito(
                              ...
                              color: isToday
                                  ? AppColors.primary
                                  : const Color(0xFF2D4A18))),
                      if (dayEvs.isNotEmpty) ...[
                        const SizedBox(height: 2),
                        Wrap(
                          alignment: WrapAlignment.center,
                          spacing: 2,
                          children: dayEvs.take(2).map((e) =>
                            Container(
                              width: 6, height: 6,
                              decoration: BoxDecoration(
                                color: _parseColor(
                                    e['color_hex'] as String?),
          ...
          ...upcoming.map((e) => Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border(left: BorderSide(
                  color: _parseColor(e['color_hex'] as String?),
                  width: 4)),
              boxShadow: [BoxShadow(
                  color: Colors.black.withOpacity(0.04),
                  blurRadius: 5)]),
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(
                        ...
                        blurRadius: 8)],
                    border: Border.all(
                        color: const Color(0xFFFDE047), width: 1.5)),
                  child: Row(children: [
                    Container(
                      width: 52, height: 52,
                      decoration: BoxDecoration(
                    ...
                    Expanded(child: Column(
                      ...
                      children: [
                        Text(
                          cert['reference_type'] == 'manual'
                              ? 'Certificate of Achievement'
                              : 'Certificate of ${(cert['reference_type'] ?? 'completion').toString().capitalize()}',
                          style: GoogleFonts.nunito(
                              fontSize: 14,
                              fontWeight: FontWeight.w800,
                              color: const Color(0xFF2D4A18))),
                        ...
                        Text(
                          'Issued ${_fmtDateShort(cert['issued_at'] as String?)}',
                          style: GoogleFonts.nunito(
                              fontSize: 12, color: Colors.grey)),
                        const SizedBox(height: 4),
                        Container(
                    ...
                    if (cert['certificate_url'] != null)
                      IconButton(
                        ...
                        onPressed: () async {
                          final uri = Uri.parse(
                              cert['certificate_url'] as String);
                          if (await canLaunchUrl(uri)) {
                            await launchUrl(uri,
                                mode: LaunchMode.externalApplication);
                          }
