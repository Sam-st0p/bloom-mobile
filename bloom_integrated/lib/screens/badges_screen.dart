...
class CertificateCard extends StatelessWidget {
  final String certTitle, name, code, issued;
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          begin: Alignment.topLeft, end: Alignment.bottomRight),
        borderRadius: BorderRadius.circular(8),
        border: Border.all(color: const Color(0xFF2D6A2D), width: 6),
        boxShadow: [BoxShadow(
      ...
      child: Stack(children: [
        ...
        Positioned.fill(child: Padding(
          ...
          child: DecoratedBox(
            decoration: BoxDecoration(
              border: Border.all(color: const Color(0xFF2D6A2D).withOpacity(0.2), width: 1),
          ...
          child: Column(
            ...
            children: [
              ...
              Column(children: [
                Text('CAVITE STATE UNIVERSITY',
                    style: GoogleFonts.nunito(
                        ...
                        color: const Color(0xFF2D6A2D), letterSpacing: 2.5),
                ...
                const SizedBox(height: 8),
                Row(children: [
                  Expanded(child: Divider(color: const Color(0xFF2D6A2D).withOpacity(0.4), thickness: 1)),
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: const Icon(Icons.eco_outlined, size: 12, color: Color(0xFF2D6A2D)),
                    ),
                  ),
                  Expanded(child: Divider(color: const Color(0xFF2D6A2D).withOpacity(0.4), thickness: 1)),
                ]),
              ...
              Column(children: [
                ...
                const SizedBox(height: 8),
                Text(
                  'has successfully completed the requirements of the BLOOM GAD e-Learning Program '
                  'and is hereby awarded this certificate in recognition of outstanding participation '
                  'and commitment to Gender and Development advocacy.',
                  style: GoogleFonts.nunito(
              ...
              Row(
                ...
                children: [
                  Expanded(child: CertSignatureBlock(title: 'GAD Coordinator', sub: 'CvSU')),
                  // Center seal + code
                  Flexible(child: Column(mainAxisSize: MainAxisSize.min, children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        border: Border.all(color: const Color(0xFF2D6A2D), width: 2),
                        color: const Color(0xFFE8F5E9)),
                      child: const Icon(Icons.verified_outlined, size: 16, color: Color(0xFF2D6A2D)),
                    ),
                    const SizedBox(height: 3),
                  ...
                  Expanded(child: CertSignatureBlock(title: 'GADRC Director', sub: 'CvSU')),
                ],
              ),
            ],
          ),
  ...
  List<Widget> _corners() {
    const size = 16.0;
    const color = Color(0xFF2D6A2D);
    return [
      Positioned(top: 14, left: 14,  child: CertCorner(color: color, size: size, flip: false, vert: false)),
      Positioned(top: 14, right: 14, child: CertCorner(color: color, size: size, flip: true,  vert: false)),
      Positioned(bottom: 14, left: 14,  child: CertCorner(color: color, size: size, flip: false, vert: true)),
      Positioned(bottom: 14, right: 14, child: CertCorner(color: color, size: size, flip: true,  vert: true)),
    ];
  }
}
